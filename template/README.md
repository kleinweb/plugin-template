...
A WordPress plugin template built with modern PHP practices: Composer, PHP-DI service container, PHP 8.3+ attributes, and Vite for assets.
...
$settings = \PluginName\plugin()->get(SettingsRegistry::class);
```
